    ...
    <section className="about section" id="about">
        ...
        <div className="about__container container grid">
            ...
            <div className="about__data">
              <Info />
              <p className="about__description">An Enthusiastic Full-Stack Developer with 9 months of experience in building and deploying full-stack web applications using
