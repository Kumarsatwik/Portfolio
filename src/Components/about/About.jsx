  ...
  return (
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        <img src={profileme} className="about__img" alt="" />

        <div className="about__data">
          <Info />
          <p className="about__description">
            An Enthusiastic Full-Stack Developer with 9 months of experience in
            building and deploying full-stack web applications using JavaScript,
            ReactJS, Tailwind CSS, FastAPI, and Django and Python. Proficient in
